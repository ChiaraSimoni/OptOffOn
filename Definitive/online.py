...
def main(argv):
    ...
    prices_df = prices_df + np.random.normal(0, 0.1, [prices_df.shape[0],prices_df.shape[1]])
    ...
    result.legend(['Load', 'PV', 'UChp', 'GASChp', 'Grid', 'Storage'], fancybox=True, framealpha=0.5)
